...
namespace UrlTracker.Core.Tests.Intercepting
{
    public class RegexRedirectInterceptorTests
    {
        ...
        {
            var entry1 = new RedirectEntity(default, default, default, default, EntityStrategy.RegexSource(@"\/ipsum"), EntityStrategy.UrlTarget("https://example.com"));
            ...
            var entry2 = new RedirectEntity(default, default, default, default, EntityStrategy.RegexSource(@"^lorem\?ipsum=[0-9]{3}$"), EntityStrategy.UrlTarget("https://example.com"));
