...
namespace UrlTracker.Core.Tests.Intercepting
{
    public class StaticUrlRedirectMatcherTests
    {
        ...
        {
            var result1 = new RedirectEntity(default, default, default, default, EntityStrategy.UrlSource("http://example.com/"), default);
            var result2 = new RedirectEntity(default, default, default, default, EntityStrategy.UrlSource("http://example.com/lorem"), default);
