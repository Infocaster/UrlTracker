...
namespace UrlTracker.Middleware.Tests
{
    public class UrlTrackerClientErrorTrackingMiddlewareTests : TestBase
    {
        ...
        public override void SetUp()
        {
            ...
            _testSubject = new UrlTrackerClientErrorTrackingMiddleware(context => Task.CompletedTask, ClientErrorService, ClientErrorFilterCollection, new VoidLogger<UrlTrackerClientErrorTrackingMiddleware>(), RequestHandlerSettings, RequestAbstraction, RuntimeState);
        }
