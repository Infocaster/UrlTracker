...
namespace UrlTracker.Core.Compatibility
{
    ...
    public abstract class CompatibilityRepositoryBase<TId, TEntity> : IReadWriteQueryRepository<TId, TEntity>
        where TEntity : class, IEntity
    {
        private ICompatibilityRepositoryCachePolicy<TEntity, TId> _cachePolicy;

        protected CompatibilityRepositoryBase(IScopeAccessor scopeAccessor, AppCaches appCaches, ILogger logger)
        {
        ...
        private static CompatibilityRepositoryCachePolicyOptions _defaultOptions;
        // ReSharper disable once InconsistentNaming
        protected virtual CompatibilityRepositoryCachePolicyOptions DefaultOptions
        {
            get
            {
                return _defaultOptions ?? (_defaultOptions
                    = new CompatibilityRepositoryCachePolicyOptions(() =>
                    {
        ...
        protected ICompatibilityRepositoryCachePolicy<TEntity, TId> CachePolicy
        {
            get
            {
                if (AppCaches == AppCaches.NoCache)
                    return CompatibilityNoCacheRepositoryCachePolicy<TEntity, TId>.Instance;
        ...
        protected virtual ICompatibilityRepositoryCachePolicy<TEntity, TId> CreateCachePolicy()
        {
            return new CompatibilityDefaultRepositoryCachePolicy<TEntity, TId>(GlobalIsolatedCache, ScopeAccessor, DefaultOptions);
        }
