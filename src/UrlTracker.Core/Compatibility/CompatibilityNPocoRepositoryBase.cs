...
namespace UrlTracker.Core.Compatibility
{
    ...
    public abstract class CompatibilityNPocoRepositoryBase<TId, TEntity> : CompatibilityRepositoryBase<TId, TEntity>
        where TEntity : class, IEntity
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompatibilityNPocoRepositoryBase{TId, TEntity}"/> class.
        /// </summary>
        protected CompatibilityNPocoRepositoryBase(IScopeAccessor scopeAccessor, AppCaches cache, ILogger logger)
        ...
        protected override int PerformCount(IQuery<TEntity> query)
        {
            ...
            var translator = new CompatibilitySqlTranslator<TEntity>(sqlClause, query);
