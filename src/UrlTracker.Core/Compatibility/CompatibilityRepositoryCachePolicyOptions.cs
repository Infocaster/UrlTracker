...
namespace UrlTracker.Core.Compatibility
{
    ...
    /// </summary>
    public class CompatibilityRepositoryCachePolicyOptions
    {
        /// <summary>
        /// Ctor - sets GetAllCacheValidateCount = true
        /// </summary>
        public CompatibilityRepositoryCachePolicyOptions(Func<int> performCount)
        {
        ...
        /// </summary>
        public CompatibilityRepositoryCachePolicyOptions()
        {
            PerformCount = null;
