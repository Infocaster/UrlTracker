...
namespace UrlTracker.Core.Compatibility
{
    ...
    /// </remarks>
    internal class CompatibilityDefaultRepositoryCachePolicy<TEntity, TId> : RepositoryCachePolicyBase<TEntity, TId>
        where TEntity : class, IEntity
    {
        private static readonly TEntity[] s_emptyEntities = new TEntity[0]; // const
        private readonly CompatibilityRepositoryCachePolicyOptions _options;

        public CompatibilityDefaultRepositoryCachePolicy(IAppPolicyCache cache, IScopeAccessor scopeAccessor, CompatibilityRepositoryCachePolicyOptions options)
