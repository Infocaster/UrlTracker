...
{
    internal class CompatibilityNoCacheRepositoryCachePolicy<TEntity, TId> : ICompatibilityRepositoryCachePolicy<TEntity, TId>
        where TEntity : class, IEntity
    {
        private CompatibilityNoCacheRepositoryCachePolicy() { }

        public static CompatibilityNoCacheRepositoryCachePolicy<TEntity, TId> Instance { get; } = new CompatibilityNoCacheRepositoryCachePolicy<TEntity, TId>();
