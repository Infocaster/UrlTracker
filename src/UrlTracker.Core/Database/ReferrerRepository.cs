...
namespace UrlTracker.Core.Database
{
    ...
    public class ReferrerRepository
        : CompatibilityNPocoRepositoryBase<int, IReferrer>, IReferrerRepository
    {
        ...
        public ReferrerRepository(IScopeAccessor scopeAccessor, AppCaches appCaches, ILogger logger)
        ...
        protected override IEnumerable<IReferrer> PerformGetByQuery(IQuery<IReferrer> query)
        {
            ...
            var translator = new CompatibilitySqlTranslator<IReferrer>(sql, query);
