...
namespace UrlTracker.Core.Database.Migrations
{
        ...
        : MigrationBase
    {
        ...
        public M202208011724_MigrateOldData(IMigrationContext context, ILogger logger)
            : base(context)
        {
            _logger = logger;
        }
        ...
        public override void Migrate()
        {
            ...
            _logger.Info<M202208011724_MigrateOldData>("Transferring referrers from old table structure");
            ...
            _logger.Info<M202208011724_MigrateOldData>("Transferring client error urls from old table structure");
            ...
            _logger.Info<M202208011724_MigrateOldData>("Transferring client error instances from old table structure");
            ...
            WHERE [icUrlTracker].Is404 = 1 and [icUrlTracker].OldUrl is not null
            ORDER BY createDate"), items =>
            {
                Database.BulkInsertRecords(items);
            });

            // transfer ignores
            _logger.Info<M202208011724_MigrateOldData>("Transferring ignored client errors from old table structure");
            Database.Execute(
...
from [icUrlTrackerIgnore404] where [urltrackerClientError].[url] = [icUrlTrackerIgnore404].[Url]");
            ...
            // transfer redirects
            _logger.Info<M202208011724_MigrateOldData>("Transferring redirects from old table structure");
