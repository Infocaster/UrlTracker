...
import type { UUITabElement } from '@umbraco-ui/uui-tabs';
 ...
 */
@defineElement('urltracker-tab-group')
export class UrlTrackerTabGroupElement extends LitElement {
  @query('#more-button')
...
declare global {
  interface HTMLElementTagNameMap {
    'urltracker-tab-group': UrlTrackerTabGroupElement;
  }
}