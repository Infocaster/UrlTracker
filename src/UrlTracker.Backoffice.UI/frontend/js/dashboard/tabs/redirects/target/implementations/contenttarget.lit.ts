...
let baseType = UrlTrackerRedirectTarget(
  LitElement,
  "urlTrackerRedirectTarget_content"
);
...
export class UrlTrackerContentRedirectTarget extends baseType {
  ...
  async connectedCallback(): Promise<void> {
    ...
    this.changeManager.element.addEventListener(
  ...
  disconnectedCallback(): void {
    ...
    ensureServiceExists(this.changeManager, "changeManager");
    this.changeManager.element.removeEventListener(
      ContentUpdateEvent.event,
      this.onContentUpdate
    );
  }
