...
strategyCollection.registerFactory(
  new ImageRecommendationTypeStrategyFactory(variableResource)
);
strategyCollection.registerFactory(
  new FileRecommendationTypeStrategyFactory(variableResource)
);
strategyCollection.registerFactory(
  new PageRecommendationTypeStrategyFactory(variableResource)
);
strategyCollection.registerFactory(
  new TechnicalFileRecommendationTypeStrategyFactory(variableResource)
);
