...
export interface IRecommendationsAnalysisService {
  getHistory: (id: number, request: IGetHistoryRequest) => Promise<IRecommendationHistoryResponse>;

  getReferrers: (id: number) => Promise<IRecommendationReferrerResponse>;
}
...
export class RecommendationsAnalysisService implements IRecommendationsAnalysisService {
  ...
  public async getHistory(id: number, request: IGetHistoryRequest) {
  ...
  public async getReferrers(id: number) {
